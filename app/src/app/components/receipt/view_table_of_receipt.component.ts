...
export class view_table_of_receiptComponent {
  page: any = { dep: {} };
  constructor(
  ...
  sd_6O8tKNbGl02kCN3l(bh) {
    try {
      bh = this.sd_N15bOYlnaFwWpmE6(bh);
  ...
  sd_N15bOYlnaFwWpmE6(bh) {
    try {
      //appendnew_next_sd_N15bOYlnaFwWpmE6
      return bh;
    } catch (e) {
      return this.errorHandler(bh, e, 'sd_N15bOYlnaFwWpmE6');
    }
  }
